...
//   final Widget child;
//   Event event;
//     StateContainer({Key? key,required this.child,required this.event
//    }) : super(key: key);
//
//   static StateContainerState of(BuildContext context){
//     return(context.dependOnInheritedWidgetOfExactType
//     <InheritedContainer>())!.data;
//   }
//
//   @override
...
//   late Event event;
//
//   void updateInfo({eventName,eventDetails,evenCountry,eventData})
//   {
//     if(event ==null){
//       event =  Event(eventName:eventName, eventDetails:eventDetails,
//           eventCountryName:evenCountry, eventDate:eventData);
//       setState(() {
//         event =event;
//       });
//     }
...
//         event.eventCountryName=eventDetails?? event.eventCountryName;
//         event.eventDate=eventData?? event.eventDate;
//       });
//     }
//   }
//
